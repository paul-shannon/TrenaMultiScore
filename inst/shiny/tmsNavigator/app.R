...
library(R6)
#library(devtools)
#install_github("paul-shannon/BioShiny")
library(dataTableWidget)
#install_github("paulshannon/HeatmapWidget")
library(HeatmapWidget)
#install_github("paulshannon/msgBoxWidget")
library(msgBoxWidget)
#install_github("paulshannon/GOEnrichmentWidget")
library(GOEnrichmentWidget)
#install_github("paul-shannon/igvShiny")
#install_github("paulshannon/GenomeTracksWidget")
